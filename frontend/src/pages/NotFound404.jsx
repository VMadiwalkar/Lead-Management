    ...
    <div className="min-h-screen flex items-center bg-orange-50">
      <div className="container mx-auto px-6 grid md:grid-cols-2 gap-8 items-center">
        <div className="py-10">
          ...
          <p className="text-gray-600 mb-6">Error 404 Page not found. Sorry the page you looking for doesn’t exist or has been moved</p>
        ...
        <div className="hidden md:block">
          <img src={LoginImg} alt="404" className="w-full h-[28rem] object-cover rounded-xl shadow-sm" />
        </div>
      </div>
    </div>
  );
