  ...
  return (
    <div className="w-full">
      ...
      <div className="text-center mb-6">
        ...
        <p className="text-xs text-blue-900 mt-1">TRANSFORMING BUSINESS - RADICALLY</p>
      </div>
      ...
      <div className="space-y-2">
        <button
          type="button"
          className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg shadow-sm bg-blue-600 text-white hover:bg-blue-700 transition duration-300"
        >
